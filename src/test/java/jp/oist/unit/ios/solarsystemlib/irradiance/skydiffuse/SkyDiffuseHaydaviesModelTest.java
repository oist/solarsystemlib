...
public class SkyDiffuseHaydaviesModelTest extends TestCase {
    ...
    public void testEstimate() {
        ...
        SkyDiffuseModel haydavies = models.getSkyDiffuseModel();
        double skyDiffuse = haydavies.estimate(surfaceTilt, surfaceAzimuth, sp, irrad, am);
        assertEquals(0, TestUtils.compareTo(251.8392542179933, skyDiffuse, 6));
    }
}