...
public class SkyDiffuseIsotropicModelTest extends TestCase {
    ...
    private ModelCollection models = new DefaultModelCollection() {
        ...
        public SkyDiffuseModel getSkyDiffuseModel() {
            return new SkyDiffuseIsotropicModel(this);
        }
    };
    ...
    public void testEstimate() {
        ...
        SkyDiffuseModel isotropic = models.getSkyDiffuseModel();
        double skyDiffuse = isotropic.estimate(surfaceTilt, surfaceAzimuth, sp, irrad, am);
        assertEquals(0, TestUtils.compareTo(251.8377025945533, skyDiffuse, 6));
    }
}